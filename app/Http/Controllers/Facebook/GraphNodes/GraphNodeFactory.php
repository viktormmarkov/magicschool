 ...
 *
 */
namespace App\Http\Controllers\Facebook\GraphNodes;
...
class GraphNodeFactory
{
     ...
     */
    const BASE_GRAPH_NODE_CLASS = 'App\Http\Controllers\Facebook\GraphNodes\GraphNode';

    /**
     * @const string The base graph edge class.
     */
    const BASE_GRAPH_EDGE_CLASS = 'App\Http\Controllers\Facebook\GraphNodes\GraphEdge';

    /**
     * @const string The graph object prefix.
     */
    const BASE_GRAPH_OBJECT_PREFIX = 'App\Http\Controllers\Facebook\GraphNodes\\';
